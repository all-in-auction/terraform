...
resource "aws_security_group_rule" "egress_rule_mysql" {
  type              = "egress"
  from_port         = 0
  to_port           = 0
  protocol          = "-1"
...
resource "aws_security_group_rule" "allow_batch_to_mysql1" {
  type                     = "ingress"
  from_port                = 3306
  to_port                  = 3306
  protocol                 = "tcp"
...
resource "aws_security_group_rule" "allow_batch_to_mysql2" {
  type                     = "ingress"
  from_port                = 3307
  to_port                  = 3307
  protocol                 = "tcp"
